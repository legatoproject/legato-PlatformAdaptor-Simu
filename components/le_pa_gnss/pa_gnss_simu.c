...
)
{
    ...
    // Set values to MAX
    *gpsTimePtr             = UINT64_MAX;
    *currentLeapSecondsPtr  = INT32_MAX;
    *changeEventTimePtr     = UINT64_MAX;
    *nextLeapSecondsPtr     = INT32_MAX;
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t pa_gnss_DownloadExtendedEphemeris
(
